  ...
  pc.onicecandidate = function(evt) {
    if (evt.candidate) {
      util.log('Received ICE candidates for:', connection.peer + 
			" candidate : " + evt.candidate + "  connectionId: "+ connection.id);
...
function Peer(id, options) {
  ...
  //console.log("Config : "+this.options.config.iceServers[0].url)
...
Socket.prototype.send = function(data) {
  ...
  if (this._wsOpen()) {
//		("socket send wsOpen : " + message);
    this._socket.send(message);
  } else {
//		console.log("socket send use http : " + data.type.toLowerCase());
    var http = new XMLHttpRequest();
